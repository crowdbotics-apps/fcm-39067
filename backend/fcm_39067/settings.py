"""
Django settings for fcm_39067 project.
...
WSGI_APPLICATION = 'fcm_39067.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "fcm_39067 API",
    "DESCRIPTION": "API documentation for fcm_39067 App",
    "VERSION": "v1",
}
